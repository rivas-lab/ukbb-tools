...
compute_md5sum () {
    ...
    cat_or_zcat ${master_phe_f} | cut -f${idx} | tail -n+2 | md5sum | awk -v ID=${GBE_ID} -v OFS='\t' '{print ID, $1}'
}


get_col_idx ${tmp_master_phe} QT_FC21057
get_col_idx ${tmp_master_phe} QT_FC10021057
