...
sbatch -p mrivas,owners,normal --nodes=1 --mem=8000 --cores=1 --time=1:00:00 --job-name=ldsc_munge --output=logs/ldsc_munge.%A_%a.out --error=logs/ldsc_munge.%A_%a.err --array=1-901 /oak/stanford/groups/mrivas/users/ytanigaw/repos/yk-tanigawa/resbatch/parallel-sbatch.sh 1_LDSC_munge.sh 6_ldsc_munge.input.lst 2
