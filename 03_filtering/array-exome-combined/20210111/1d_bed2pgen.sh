...
sbatch -p mrivas --qos=high_p --time=2-0:0:00 --mem=64000 --nodes=1 --cores=8 --job-name=bed2pgen --output=logs/bed2pgen.%A.out --error=logs/bed2pgen.%A.err 1d_bed2pgen.sh
