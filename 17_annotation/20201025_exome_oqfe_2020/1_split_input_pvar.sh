...
# pvar="/scratch/groups/mrivas/ukbb24983/exome-oqfe2020-annotation/UKBexomeOQFE.pvar.zst"
# data_d="/scratch/groups/mrivas/ukbb24983/exome-oqfe2020-annotation/input"
pvar="/scratch/groups/mrivas/ukbb24983/exome/annotation/20201025_exome_oqfe_2020/UKBexomeOQFE.pvar.zst"
data_d='/scratch/groups/mrivas/ukbb24983/exome/annotation/20201025_exome_oqfe_2020/input'
...
split --lines 20000 --numeric-suffixes=1 --suffix-length 3 ${tmp_pvar_body} ${tmp_dir}/${tmp_pvar_split_prefix}
