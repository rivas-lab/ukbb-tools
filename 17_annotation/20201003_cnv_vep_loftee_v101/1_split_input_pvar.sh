...
pvar="/oak/stanford/groups/mrivas/ukbb24983/cnv/pgen/cnv.pvar"
data_d="/scratch/groups/mrivas/ukbb24983/cnv/annotation_20201003/input"
...
split --lines 276 --numeric-suffixes=1 --suffix-length 3 ${tmp_pvar_body} ${tmp_dir}/${tmp_pvar_split_prefix}
