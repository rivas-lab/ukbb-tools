...
pvar="/scratch/groups/mrivas/ukbb24983/cnv/annotation_20201003/cnv.20201007.unfinished.pvar"
data_d="/scratch/groups/mrivas/ukbb24983/cnv/annotation_20201003/input_20201007"
...
split --lines 1 --numeric-suffixes=1 --suffix-length 4 ${tmp_pvar_body} ${tmp_dir}/${tmp_pvar_split_prefix}
