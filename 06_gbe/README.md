...
1. An input table (line 20) and corresponding arguments on lines 21-27. These lines should be filled in with the (zero-indexed) corresponding column indices of your input table. A table consisting of the input parameters for each table that we have in `02_phenotyping/tables` can be found [here](https://docs.google.com/spreadsheets/d/1d4w4A8takvPxpHoUFXoNjj3a3QZLc-oHQiMaA5eElRg/edit?usp=sharing).
