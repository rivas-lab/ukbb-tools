...
Want info on how to define phenotypes ([`tsv_to_phenos.py`]()) or run GWAS ([`gbe.sh`]()) with these tables? The parameters you'll need to use are documented [here](https://docs.google.com/spreadsheets/d/1d4w4A8takvPxpHoUFXoNjj3a3QZLc-oHQiMaA5eElRg/). 
